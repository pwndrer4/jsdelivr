  ...
  <div class="page">
        <div class="navbar navbar-large-transparent">
          ...
          <a href="#" class="link back">
            ...
            <div class="title sliding">关于我们</div>
            <div class="title-large">
              <div class="title-large-text">关于我们</div>
            </div>
          </div>
        </div>
...
$string = file_get_contents("../json/hacked.json");
  ...
  <li style="width:90%;border-radius:10px;margin:10px;background-color:#f2f2f2;">
      <a onclick="location='<?php echo $appkey['plist']; ?>'" class="item-link item-content">
        ...
        <div class="item-inner">
          ...
          <div style="text-align:justify;" class="item-subtitle"><span style="margin-right:5px;" class="badge color-red">Size:0MB</span><span class="badge color-purple">关于我们</span></div>
        </div>
      </a>
    </li>
<?php
