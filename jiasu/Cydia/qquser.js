...
function loadPackages() {
	var offset = 0;
	offset = document.getElementById("sections1").children.length;
	$.ajax({
		type: 'GET',
		url: siteurl + 'Sections1.php?pid=' + $('#loadmore').attr("name") + '&method=more' + '&offset=' + offset,
		dataType: 'html',
		cache: true,
