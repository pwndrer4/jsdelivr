...
var txt1=["(不兼容)","(不兼容)","(一般)","(一般)","(一般)","(还行)","(还行)","(还行)","(完全兼容)","(完全兼容)"];
var txt2=["(百年不动)","(百年不动)","(有点慢哦)","(有点慢哦)","(有点慢哦)","(正常)","(挺快)","(像刘翔那么快)","(灰机一样快)","(灰机一样快)"];
var txt3=["(作者没毕业)","(作者没毕业)","(BUG太多了)","(BUG太多了)","(不敢恭维)","(不敢恭维)","(还行)","(还行)","(极品)","(极品)"];
